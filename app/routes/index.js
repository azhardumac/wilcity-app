...
class RootStack extends Component {
  ...
  async componentDidMount() {
    ...
    if (configureApp.turnOnNearByWhenOpeningApp) {
      await this._getLocationAsync();
    }
    await getSettings();
    // set default locale
    setLocale(locale);
    await Promise.all([getTranslations(), getHomeScreen(), getTabNavigator()]);
